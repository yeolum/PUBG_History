...
export default function StageMatchesPage() {
  const { id: tournamentId, seriesId, stageId } = useParams() as { id: string; seriesId: string; stageId: string }
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-xs text-gray-400 border-b border-gray-100">
                  ...
                  <th className="text-right px-5 py-2">킬</th>
                  <th className="text-right px-5 py-2">데미지</th>
                  <th className="text-right px-5 py-2 font-bold">포인트</th>
                </tr>
              </thead>
              <tbody>
                {standings.map((s, i) => (
                  <tr key={s.team_id} className="border-b border-gray-50 last:border-0">
                    ...
                    <td className="px-5 py-2 font-medium text-gray-800">{s.team_name}</td>
                    ...
                    <td className="px-5 py-2 text-right text-gray-500">{Number(s.total_damage).toFixed(0)}</td>
