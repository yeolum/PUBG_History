...
-- =====================================================
-- Migration: per-stage and per-series pre-computed player stats
-- Allows the Player Data tab to load from the right granularity
-- instead of aggregating match_player_stats client-side.
-- =====================================================
...
-- =====================================================
-- Migration: smash rule sub-type column
-- Stores which sub-rule is used for ranks 2+ in the Smash rule.
-- =====================================================
